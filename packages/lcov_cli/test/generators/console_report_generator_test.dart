...
//   test('generate returns null as no file is produced', () async {
//     final generator = ConsoleReportGenerator(
//       codeFiles: [],
...
//   test('generate handles empty code files list', () async {
//     final generator = ConsoleReportGenerator(
//       codeFiles: [],
//       outputDir: tempDir.path,
//     );
...
//   test('generate correctly calculates totals with multiple files', () async {
//     final generator = ConsoleReportGenerator(
//       codeFiles: [
//         CodeFile(
//           path: 'test1.dart',
...
//           path: 'test2.dart',
//           codeLines: [
//             Line(lineNumber: 1, lineContent: 'line1', canHitLine: true, hitCount: 1, isModified: true),
//           ],
//         ),
//       ],
//       outputDir: tempDir.path,
...
//   test('generate handles relative paths when rootPath is provided', () async {
//     final generator = ConsoleReportGenerator(
//       codeFiles: [
//         CodeFile(
//           path: '/root/path/test.dart',
//           codeLines: [
//             Line(lineNumber: 1, lineContent: 'line1', canHitLine: true, hitCount: 1),
//           ],
//         ),
...
//     expect(() => generator.generate('/root/path/'), returnsNormally);
//   });

//   test('generate handles files with no hittable lines', () async {
//     final generator = ConsoleReportGenerator(
//       codeFiles: [
//         CodeFile(
//           path: 'test.dart',
